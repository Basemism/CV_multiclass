...
parser.add_argument('--weights', type=str, default='./clip_weights/clip_model_256_epochs_50.pth', help='Path to segmentation weights file')
parser.add_argument('--metrics', type=str, default='./metrics/clip_model_256_epochs_50.txt', help='Path to metrics file')
